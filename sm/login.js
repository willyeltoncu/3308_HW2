...
function enableButton(letter, capital, number, length, match) {
    ...
    if(letter.classList.contains("invalid")) condition = false;
    if(capital.classList.contains("invalid"))condition = false;
    if(number.classList.contains("invalid"))condition = false;
    if(length.classList.contains("invalid"))condition = false;
    if(match.classList.contains("invalid"))condition = false;
